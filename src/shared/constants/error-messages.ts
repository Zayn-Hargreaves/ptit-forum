...
export const ERROR_MESSAGES: Record<number, string> = {
  ...
  // Password Reset
  [BACKEND_ERROR_CODES.SESSION_RESET_PASSWORD_NOT_FOUND]: 'Không tìm thấy phiên đặt lại mật khẩu',
  [BACKEND_ERROR_CODES.SESSION_RESET_PASSWORD_HAS_USED]: 'Phiên đặt lại mật khẩu đã được sử dụng',
