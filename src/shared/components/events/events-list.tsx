...
const events = [
  {
    ...
    description: 'Tìm hiểu về xu hướng AI và ứng dụng thực tế trong doanh nghiệp',
    date: '2024-11-20',
    time: '14:00 - 16:00',
  ...
  },
  {
    ...
    description: 'Gặp gỡ các nhà tuyển dụng hàng đầu và tìm kiếm cơ hội việc làm',
    date: '2024-11-25',
    time: '08:00 - 17:00',
          ...
          >
            ...
            <CardContent className="p-6">
              ...
              <Link href={`/events/${event.id}`}>
                <h3 className="hover:text-primary mb-2 text-xl leading-tight font-semibold">
                  {event.title}
                </h3>
              </Link>
