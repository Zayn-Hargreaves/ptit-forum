...
export const topicApi = {
    ...
    search: async (params: TopicSearchParams) => {
        ...
        const res = await apiClient.get<ApiResponse<PageResponse<TopicResponse>>>(
            BASE_URL,
    ...
    getDetail: async (id: string) => {
        const res = await apiClient.get<ApiResponse<DetailedTopicResponse>>(
            `${BASE_URL}/${id}`
        );
    ...
    softDelete: async (id: string) => {
        const res = await apiClient.delete<ApiResponse<TopicResponse>>(
