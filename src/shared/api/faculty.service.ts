...
export const getAllFaculties = async (params: {
    ...
    const res = await apiClient.get<ApiResponse<PageResponse<Faculty>>>(
        '/admin/faculties',
        {params: {page, size}}
    );
...
export const createFaculty = async (payload: FacultyPayload) => {
    const res = await apiClient.post<ApiResponse<Faculty>>(
        '/admin/faculties',
        payload
    );
...
export const updateFaculty = async (
    ...
    const res = await apiClient.put<ApiResponse<Faculty>>(
        `/admin/faculties/${id}`,
        payload
    );
    return res.data.result;
