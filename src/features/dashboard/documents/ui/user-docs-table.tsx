...
import { deleteDocument, getMyDocuments } from '@shared/api/document.service';
...
import { AlertCircle, Download, Eye, MoreHorizontal, Pencil, Trash2 } from 'lucide-react';
    ...
    },
    {
      ...
      cell: ({ row }) => {
        ...
        const rejectionReason =
          ...
          'Common issues: Low quality content or copyright violation.';
              ...
              <Popover>
                <PopoverTrigger asChild>
                  <Button
                    variant="ghost"
                    size="icon"
                    className="text-destructive hover:bg-destructive/10 h-6 w-6 rounded-full"
                  >
                ...
                <PopoverContent className="w-80">
                  <div className="space-y-2">
                    <h4 className="text-destructive flex items-center gap-2 leading-none font-medium">
                      <AlertCircle className="h-4 w-4" />
                      Rejection Reason
                    </h4>
