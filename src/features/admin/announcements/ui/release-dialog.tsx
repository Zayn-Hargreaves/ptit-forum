            ...
            <DialogContent>
                ...
                <div className="grid gap-4 py-4">
                    ...
                    <div className="grid gap-2">
                        ...
                        <Select value={selectedCohort} onValueChange={(val) => setSelectedCohort(val as CohortCode | "ALL")}>
                            <SelectTrigger>
                ...
                <DialogFooter>
                    <Button variant="outline" onClick={close} disabled={isProcessing}>Hủy</Button>
