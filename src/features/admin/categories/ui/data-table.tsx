...
import {
  ...
  SelectItem,
  SelectTrigger,
  SelectValue, // Import Select component
  Table,
  TableBody,
  TableCell,
  TableHead,
    ...
    <div className="space-y-4">
      ...
      <div className="flex items-center justify-between gap-2">
        <div className="flex flex-1 items-center gap-2">
          ...
          <Select value={currentFilterValue} onValueChange={handleTypeFilterChange}>
            <SelectTrigger className="h-9 w-[200px]">
              <SelectValue placeholder="Lọc theo loại" />
            </SelectTrigger>
            <SelectContent>
              <SelectItem value="ALL">Tất cả loại</SelectItem>
              <SelectItem value={CategoryType.ACADEMIC}>
                {TYPE_LABEL[CategoryType.ACADEMIC]}
              </SelectItem>
              <SelectItem value={CategoryType.CLASSROOM}>
                {TYPE_LABEL[CategoryType.CLASSROOM]}
              </SelectItem>
