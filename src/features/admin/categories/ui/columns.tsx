...
export const columns: ColumnDef<CategoryResponse>[] = [
    ...
    },
    {
        ...
        header: "Mô tả",
        cell: ({ row }) => (
            <span className="text-sm text-muted-foreground truncate max-w-[300px] block" title={row.original.description}>
    ...
    },
    {
        ...
        cell: ({ row }) => {
            ...
            return <span className="text-sm text-muted-foreground">{format(date, "dd/MM/yyyy HH:mm")}</span>;
        },
    },
    {
        id: "actions",
