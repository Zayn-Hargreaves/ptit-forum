...
export default function AdminLayout({children}: { children: React.ReactNode }) {
    ...
    return (
        <div className="flex h-screen w-full overflow-hidden">
            {/* Sidebar */}
            <aside className="w-64 border-r bg-slate-900 text-slate-50 hidden md:flex flex-col">
                <div className="flex h-14 items-center border-b border-slate-800 px-4 lg:h-[60px] lg:px-6">
                    <Link href="/admin/documents" className="flex items-center gap-2 font-bold text-lg">
